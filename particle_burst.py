...
Click anywhere on the canvas and a burst of small yellow particles
explodes outward from that point, each one following its own
velocity and fading out as it decelerates.
"""
