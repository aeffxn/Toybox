...
Click rapidly to fill the meter. When it hits 100% the whole panel
shakes and the meter resets. It also drains slowly if you stop
clicking, so you have to keep going.
"""
...
class RageMeterToy(tk.Frame):
    DRAIN_RATE = 0.008       # how much % drains per frame when not clicking
    CLICK_FILL = 0.07        # how much % each click adds
    FRAME_DELAY_MS = 16
    SHAKE_STEPS = 14
